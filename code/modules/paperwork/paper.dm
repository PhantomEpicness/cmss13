...
/obj/item/paper/uh10manuel
	name = "UH10 & UH18B armor operator quick reference pamphlet"
	info = " <p style=\"text-align: center;\"><sub>UH10 Operato Quick Reference</sub></p> <p>Comrade, you have just been granted the most heavist and kapitolist proof armor system our glorias people's republic can afford. Use it correctly and it shall serve you through the gates of hell and back without a scratch! </p> <p><i>Please read the document until you reach the <b>STOP</b>. If you have trouble understanding any part of this documennt, ask your local requisitions officer for more details.</i></p> <BR> <p>A professional heavy weapons operator's should always keep the following in mind while using the UH10 & UH18B armor systems... </p> <ul> \n <li>Due to the design of the suit's weapon, it cannot load any spare ammo nor take back any unused ammo since the loaded magazine blocks the retraction of it and is automatically ejected as a result. Therefore, one must use any and all ammo once they have extended the gun. </li> \n <li> While wearing the suit, the operator's entire body is covered, meaning that there is no way to use autoinjectors while wearing it. Removing your helmet and mask, then pilling is the way to administer medication.</li>\n <li> (UH10 ONLY) As a result of the UH10 not having the waste disposal system of the UH18B, any use of the restroom must be used before a user enters combat. Excessive water drinking and eating foods that are known to cause runny stool is not reccomended.</li> \n <li> While as tough as ever, you are still vunerable to certain threats such as, \"LTB \" cannon rounds, advanced phased plasma rifles above the 30-watt range, orbital bombardments, direct mortar strikes, railgun penetrators and anything that can either obliterate a city block or penetrate more then 600MM of RHA</li> \n <li>(UH10 ONLY) Asbestos liner was used as fire insulation in early production runs as a cheap insulator. Due to the widely known ill effects of it, it has since been ordered to be removed. (Please contact you local Supply Officer if you suspect your suit still has the asbestos liner) Therefore, one must still excercise care when confronted with fire and flame weapons.</li> \n <li> Reloading suit ammo is impossible to do on the field, however your suit should carry enough ammo for a full length operation IF you are a good comrade and do not waste bullets.</li> </ul> \n  <p><B><i> STOP</B></i></p> \n <p> Thank you for reading this phamplet, comrade. You may now start using the suit and its accompanying AK-104S integrated in-arm weapons system for the glory of the motherland! Good luck, soldier!</p>"
