...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("male_pain")
				S = pick('sound/voice/AUGH1.ogg','sound/voice/AUGH2.ogg','sound/voice/AUGH3.ogg','sound/voice/human_male_pain_1.ogg','sound/voice/human_male_pain_2.ogg','sound/voice/human_male_pain_3.ogg',5;'sound/voice/tomscream.ogg',5;'sound/voice/human_bobby_pain.ogg',5;'sound/voice/human_tantrum_scream.ogg', 5;'sound/voice/human_male_pain_rare_1.ogg')
			if("male_fragout")
